                  ...
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2">
                        <Ticket className={`w-4 h-4 shrink-0 ${isSelected ? 'text-brand' : 'text-gray-400'}`} />
                        <p className="font-medium text-black text-sm truncate">
                          {coupon.display_name || coupon.code}
                        </p>
                      </div>
                      <div className="flex items-center gap-2 mt-1">
                        <p className={`font-bold text-sm ${isSelected ? 'text-brand' : 'text-gray-700'}`}>
            ...
            {showCouponList && (
              <div className="mt-2 flex gap-2">
                <input
                  ...
                  className="flex-1 px-4 py-2.5 border border-gray-300 rounded-lg text-black focus:outline-none focus:ring-2 focus:ring-brand"
        ...
        <div className="bg-white mt-2 p-4 lg:rounded-lg">
          ...
          <div className="flex items-center justify-between p-3 rounded-lg border border-dashed border-gray-300 bg-gray-50">
            ...
            <button
              ...
              className="text-sm font-medium text-brand hover:text-brand-deep shrink-0 ml-2"
            >
              로그인
            </button>
          </div>
        ...
        <div className="space-y-2">
          ...
          {salesmanDiscount > 0 && (
            <div className="flex justify-between text-sm p-2 -mx-2 bg-indigo-50 rounded-lg">
              ...
              <span className="text-brand font-bold">-{salesmanDiscount.toLocaleString('ko-KR')}원</span>
            </div>
          )}
          {couponDiscount > 0 && (
            <div className="flex justify-between text-sm p-2 -mx-2 bg-blue-50 rounded-lg">
              ...
              <span className="text-brand font-bold">-{couponDiscount.toLocaleString('ko-KR')}원</span>
            </div>
          )}
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="text-right">
              ...
              <span className={`text-xl font-bold ${(salesmanDiscount + couponDiscount) > 0 ? 'text-brand' : 'text-black'}`}>
          ...
          >
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-brand rounded-lg flex items-center justify-center text-white font-bold text-sm">
                  토스
                </div>
                <div>
