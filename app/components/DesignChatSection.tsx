      ...
      <div className="border-t border-gray-200 px-4 py-3 bg-white shrink-0 safe-area-bottom">
        <div className="flex items-end gap-2">
          <textarea
            ...
            rows={1}
            className="flex-1 resize-none border border-gray-300 rounded-full px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#0052CC] focus:border-transparent"
            style={{ maxHeight: '80px' }}
          />
          <button
            onClick={handleSend}
            disabled={!newMessage.trim() || sending}
            className="p-2.5 bg-[#0052CC] text-white rounded-full hover:bg-[#003D99] disabled:opacity-50 disabled:cursor-not-allowed transition-colors shrink-0"
          >
            {sending ? (
