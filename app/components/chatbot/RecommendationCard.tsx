...
export default function RecommendationCard({
  ...
  return (
    <div className="mt-3 rounded-xl border border-brand/30 bg-white overflow-hidden">
      <div className="bg-brand/5 px-3 py-2 flex items-center gap-1.5">
        <Sparkles className="w-4 h-4 text-brand" />
        <span className="text-sm font-semibold text-brand">맞춤 추천</span>
      </div>
          ...
          <div className="rounded-lg border border-brand/30 bg-brand/5 p-3 space-y-2">
            ...
            <div className="grid grid-cols-1 gap-1.5 pt-1">
              <button
                ...
                disabled={disabled}
                className="w-full py-2.5 bg-brand text-white text-sm font-medium rounded-lg hover:bg-brand-deep transition-colors flex items-center justify-center gap-1.5 disabled:opacity-50"
              >
              ...
              <button
                ...
                disabled={disabled}
                className="w-full py-2.5 bg-white text-brand border border-brand text-sm font-medium rounded-lg hover:bg-brand/5 transition-colors flex items-center justify-center gap-1.5 disabled:opacity-50"
              >
