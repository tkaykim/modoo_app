...
export default function ChatBubble() {
  ...
  return (
    <button
      onClick={handleClick}
      className="fixed bottom-24 right-4 md:bottom-8 md:right-8 z-9998 w-15 h-15 bg-linear-to-br from-brand to-brand-deep text-white rounded-full shadow-lg hover:shadow-xl hover:scale-105 active:scale-95 transition-all flex items-center justify-center animate-[float_3s_ease-in-out_infinite]"
