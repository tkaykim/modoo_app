    ...
    <div className="mt-3">
      <div className="flex items-center gap-2">
        <input
          ...
          placeholder="예: 30"
          disabled={disabled}
          className="w-24 px-3 py-2 text-sm text-center border border-gray-300 rounded-lg focus:outline-none focus:border-[#3B55A5] disabled:opacity-50"
        />
        <span className="text-sm text-gray-700">벌 정도</span>
        <button
          onClick={submit}
          disabled={disabled}
          className="ml-auto px-4 py-2 bg-[#3B55A5] text-white text-sm font-medium rounded-lg hover:bg-[#2D4280] transition-colors disabled:opacity-50 flex items-center gap-1"
        >
