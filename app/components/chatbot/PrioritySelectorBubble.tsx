    ...
    <div className="mt-3 space-y-2">
      {OPTIONS.map((o) => (
        <button
          ...
          disabled={disabled}
          className="w-full text-left p-3 rounded-lg border border-gray-300 bg-white hover:border-brand hover:bg-blue-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
