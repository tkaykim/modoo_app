        ...
        >
          ...
          <div className="p-3 border-b border-gray-200">
            ...
            >
              ...
              <span className="flex-1 text-sm font-medium text-brand">
        ...
        <div className="shrink-0 sticky top-0 border-b border-gray-100">
          ...
          <div className="flex">
            ...
            <button
              ...
              className="ml-2 p-2 rounded-lg bg-brand text-white hover:bg-brand-deep transition flex items-center justify-center"
              title="텍스트 편집"
            >
