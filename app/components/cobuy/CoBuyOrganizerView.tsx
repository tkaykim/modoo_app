      ...
      <div className="max-w-4xl mx-auto p-4 space-y-6">
              ...
              {session.status !== 'delivery_complete' && (
                <>
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-brand text-white text-sm rounded-lg hover:bg-brand-deep transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2"
                  >
        ...
        <section className="bg-white rounded-2xl shadow-sm p-6">
          ...
          {session.min_quantity && (
            <div className="mt-4 p-4 bg-brand/10 rounded-xl">
                          ...
                          <td className="py-3 text-center">
                            <div className="flex items-center justify-center gap-1">
                              <button
                                ...
                                title="수정"
                                className="p-2 text-gray-500 hover:text-brand hover:bg-blue-50 rounded-md transition-colors"
                              >
                                <Pencil className="w-4 h-4" />
                              </button>
                              {(participant.payment_status === 'pending' || (isSurveyMode && participant.payment_status === 'not_required')) && (
