        ...
        {currentStep !== 'welcome' && (
          <div className="px-4 pb-3 md:px-6 md:pb-4">
            <div className="h-1 md:h-1.5 bg-gray-100 rounded-full overflow-hidden">
              <div
                className="h-full bg-gradient-to-r from-brand to-brand-deep rounded-full transition-all duration-500 ease-out"
      ...
      <main className="flex-1 overflow-y-auto">
        <div className={`transition-all duration-150 ease-out ${animationClass}`}>
          ...
          {currentStep === 'welcome' && (
            <div className="max-w-lg mx-auto py-6 px-4 md:py-8 md:px-6">
              ...
              <div className="text-center mb-6">
                <div className="w-14 h-14 md:w-16 md:h-16 rounded-full bg-gradient-to-br from-brand to-brand-deep flex items-center justify-center mx-auto mb-4 shadow-lg shadow-brand/25">
                  <Users className="w-7 h-7 md:w-8 md:h-8 text-white" />
                </div>
                <p className="text-xs md:text-sm text-brand font-medium mb-2">공동구매 참여</p>
              ...
              {!deliverySettings?.enabled && (
                <div className="bg-blue-50 border border-blue-200 rounded-xl p-3 mb-4 flex items-start gap-2">
                  <Truck className="w-4 h-4 text-brand mt-0.5 shrink-0" />
              ...
              <button
                onClick={handleNext}
                className="w-full py-3 md:py-4 bg-gradient-to-r from-brand to-brand-deep text-white rounded-2xl font-semibold hover:from-brand-deep hover:to-[#243366] transition-all shadow-lg shadow-brand/25 flex items-center justify-center gap-2 text-sm md:text-base"
              >
                <span>참여하기</span>
          ...
          {currentStep === 'size-quantity' && (
            <div className="max-w-lg mx-auto py-6 px-4 md:py-8 md:px-6">
              <div className="mb-6">
                <div className="w-10 h-10 md:w-12 md:h-12 rounded-xl bg-brand/20 flex items-center justify-center mb-3">
                  <Ruler className="w-5 h-5 md:w-6 md:h-6 text-brand" />
                </div>
                  ...
                  <div key={index} className="flex items-start gap-2 p-3 bg-gray-50 rounded-xl">
                    ...
                    <div className="flex-1">
                      <select
                        ...
                        className={`w-full px-3 py-2.5 border-2 rounded-xl focus:outline-none focus:ring-2 focus:ring-brand text-sm md:text-base ${
              ...
              {/* Order Summary */}
              {getTotalQuantity() > 0 && (
                <div className="bg-brand/10 rounded-xl p-4 space-y-2">
                  ...
                  <div className="flex justify-between text-sm pt-2 border-t border-blue-200">
                    ...
                    <span className="font-bold text-brand text-lg">{formatPrice(calcItemsTotal())}</span>
                  </div>
            ...
            <div className="max-w-lg mx-auto py-6 px-4 md:py-8 md:px-6">
              ...
              <div className="space-y-3">
                ...
                >
                  <div className="flex items-start gap-3 md:gap-4">
                    <div className={`w-9 h-9 md:w-10 md:h-10 rounded-xl flex items-center justify-center ${
                      deliveryMethod === 'pickup' ? 'bg-brand text-white' : 'bg-gray-100 text-gray-500'
                    }`}>
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2">
                        ...
                        {deliveryMethod === 'pickup' && <Check className="w-4 h-4 md:w-5 md:h-5 text-brand" />}
                      </div>
                ...
                >
                  <div className="flex items-start gap-3 md:gap-4">
                    <div className={`w-9 h-9 md:w-10 md:h-10 rounded-xl flex items-center justify-center ${
                      deliveryMethod === 'delivery' ? 'bg-brand text-white' : 'bg-gray-100 text-gray-500'
                    }`}>
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-2">
                        ...
                        {deliveryMethod === 'delivery' && <Check className="w-4 h-4 md:w-5 md:h-5 text-brand" />}
                      </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      className="flex-1 px-4 py-3 bg-brand text-white rounded-xl hover:bg-brand-deep transition font-medium flex items-center justify-center gap-2 text-sm md:text-base"
                    >
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-brand text-sm md:text-base"
        ...
        <footer className="shrink-0 border-t border-gray-200 bg-white p-3 md:p-4 safe-area-inset-bottom">
          <div className="max-w-lg mx-auto flex gap-2 md:gap-3">
            ...
            {currentStep !== 'review' ? (
              <button
                onClick={handleNext}
                className="flex-1 py-3 md:py-4 bg-gradient-to-r from-brand to-brand-deep text-white rounded-2xl font-semibold hover:from-brand-deep hover:to-[#243366] transition-all shadow-lg shadow-brand/25 flex items-center justify-center gap-1.5 md:gap-2 text-sm md:text-base"
              >
                <span>다음</span>
                <ArrowRight className="w-4 h-4 md:w-5 md:h-5" />
              </button>
