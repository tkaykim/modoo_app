          ...
          requests.length === 0 ? (
            <div className="text-center py-16">
              ...
              <button
                ...
                className="px-5 py-2.5 bg-brand text-white rounded-xl text-sm font-medium"
              >
                새 요청 만들기
              </button>
            </div>
            ...
            <div className="space-y-3">
              ...
              <button
                onClick={() => router.push('/home/cobuy/request/create')}
                className="w-full py-3 border-2 border-dashed border-gray-200 rounded-xl text-sm text-gray-400 hover:border-brand hover:text-brand transition"
              >
                + 새 요청 만들기
              </button>
            </div>
          ...
          <div key={step.key} className="flex-1 flex flex-col items-center gap-1">
            <div
              className={`w-full h-1 rounded-full ${
                isPast || isCurrent ? 'bg-brand' : 'bg-gray-200'
              }`}
            />
            <span className={`text-[9px] ${isPast || isCurrent ? 'text-brand font-medium' : 'text-gray-300'}`}>
              {step.label}
            </span>
          </div>
        );
