    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="w-full px-4 py-6 pb-24">
        ...
        <button
          ...
          className="w-full flex items-center gap-3 rounded-xl bg-brand/5 border border-brand/15 px-4 py-3.5 mb-5 text-left hover:bg-brand/10 transition"
        >
          ...
          <span className="flex-1 min-w-0">
            ...
            <span className="block text-xs text-brand mt-0.5">챗봇으로 간편하게 상담받기 →</span>
          </span>
        </button>
        ...
        <form onSubmit={handleSubmit}>
            ...
            <FormRow label="제품">
              <div className="flex items-center gap-3 flex-wrap">
                <button
                  ...
                  className="px-4 py-1.5 text-sm bg-brand text-white hover:bg-[#2f4584] transition"
                >
                  제품선택
                </button>
          ...
          <div className="border border-gray-300 rounded-lg overflow-hidden mb-8">
            ...
            <FormRow label="정보 안내">
              <ul className="text-xs text-gray-600 space-y-1 list-disc pl-4">
                ...
                <li>용량을 초과할 경우 <span className='text-brand'>modoo.contact@gmail.com</span> 메일로 첨부해주세요.</li>
              </ul>
            </FormRow>
            ...
            <FormRow label="참고 이미지 및 파일">
              <div className="flex flex-col gap-2">
                <div className="flex items-center gap-3">
                  ...
                  <button
                    type="button"
                    className="px-4 py-2 text-sm bg-brand text-white hover:bg-[#2f4584] transition shrink-0 disabled:bg-gray-400"
          ...
          <div className="flex items-center justify-center gap-3">
            ...
            <button
              ...
              className="px-8 py-3 text-sm bg-brand text-white rounded-lg hover:bg-[#2f4584] transition disabled:bg-gray-400 disabled:cursor-not-allowed inline-flex items-center justify-center gap-2 min-w-[110px]"
            >
              {isSubmitting ? (
                <>
                  <Loader2 className="w-4 h-4 animate-spin" />
